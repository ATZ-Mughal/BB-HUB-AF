        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "📝 ᴍᴏᴠɪᴇ ꜱᴇᴀʀᴄʜ ɢʀᴏᴜᴘ ", url=f"https://t.me/BB_HUB_Chat"
                        )
                    ]
                ]
            ),
...
async def advantage_spoll_choker(bot, query):
    ...
    await query.answer("Arghhh Bro, I Do Not Have This")
...
async def cb_handler(client: Client, query: CallbackQuery):
    if query.data == "close_data":
        ...
        return await query.message.edit(
            text=f"<b>ᴛʜᴀɴᴋs ғᴏʀ ᴊᴏɪɴɪɴɢ ᴏᴜʀ ᴄʜᴀɴɴᴇʟ 🔥😗\nɢᴇᴛ ʏᴏᴜʀ ғɪʟᴇ : {files.file_name[:20]}.. ʙʏ ᴄʟɪᴄᴋɪɴɢ ᴛʜᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ ⚡\n\nᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : @Movie_Links_Hub</b>",
            reply_markup=reply_markup,
        )
            ...
            await query.message.edit_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "💸 ᴄʜᴇᴄᴋᴏᴜᴛ ᴘʀᴇᴍɪᴜᴍ ᴘʟᴀɴꜱ 💸", callback_data="seeplans"
                            )
                        ]
                    ]
                ),
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🍁 𝗖𝗹𝗶𝗰𝗸 𝗔𝗹𝗹 𝗣𝗹𝗮𝗻𝘀 & 𝗣𝗿𝗶𝗰𝗲𝘀 🍁", callback_data="free"
                )
            ],
        ...
        m = await query.message.reply_sticker(
            "CAACAgUAAxkBAAIHxGebVpENGvVSjeJHQ2402ft-Ut-EAAJ0BAACxncgVysdhZkY8CruNgQ"
        )
        await m.delete()
        ...
        buttons = [
            [
                InlineKeyboardButton(
                    "☆📸 𝙎𝙚𝙣𝙙 𝙨𝙘𝙧𝙚𝙚𝙣𝙨𝙝𝙤𝙩 📸☆", url=f"https://t.me/The_ZackRox"
                )
            ],
    ...
    # jisshu
        ...
        await query.answer(
            f"Only the bot admin can ᴏɴ ✓ or ᴏғғ ✗ this feature.", show_alert=True
        )
    ...
    # )
        ...
        await client.edit_message_media(
            ...
            media=InputMediaAnimation(
                media="CAACAgUAAxkBAAIHymebV5NxYR1oHfy5hYeRmKSmShyzAAIoAAO8ljUq2rSzMerl4ZU2BA",
        ...
        buttons = [[InlineKeyboardButton("⋞ ʙᴀᴄᴋ", callback_data="admincmd")]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [InlineKeyboardButton("Posting Channel", callback_data="Source")],
                    [
                        InlineKeyboardButton(
                            "My Developers 😎", callback_data="mydevelopers"
                        )
                    ],
        ...
        await query.answer(
            "Meet the mind behind this bot:\n\n👨‍💻 @The_ZackRox\n\n\n❤️ A big thank you for making this bot awesome!",
            show_alert=True,
        )

    elif query.data == "Source":
        buttons = [
            [InlineKeyboardButton("Join Channel", url="https://t.me/+SnGDcP8EkYY1ZmZk")],
            [
        ...
        buttons = [
            ...
            [
                ...
                InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/BB_HUB_Support"),
            ],
        ]
        reply_markup = InlineKeyboardMarkup(buttons)
        await client.edit_message_media(
            ...
            message_id=query.message.id,
            media=InputMediaAnimation(
                media="CAACAgUAAxUAAWebV5Shqzku6TvR5BnYAU_WGdAuAAItAAO8ljUqFMIAAX-nexzINgQ",
    ...
    if offset != "":
        if total_results >= MAX_BTN:
            btn.insert(
                ...
                [
                    InlineKeyboardButton(
                        "📥 𝗦𝗲𝗻𝗱 𝗔𝗹𝗹 𝗙𝗶𝗹𝗲𝘀 📥", callback_data=batch_link
                    ),
                ],
            )
            btn.insert(
